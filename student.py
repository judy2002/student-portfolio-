...
if 'name' not in st.session_state:
    st.session_state.name = "Masabato Judith"
...
if page == "Home":
    ...
    st.image("you!.jpg", width=160, caption="Default image")
...
# Projects section
    ...
    project_data = {
        ...
        "Year 2 Project": {
            "🤖 AI Chatbot": {
                ...
                "link": "https://github.com/judy2002 /YEAR-II-C"
            }
        },
        "Year 3 Project": {
            "🌐  Ines Website": {
                ...
                "link": "https://github.com/judy2002 /ines-website"
            }
        },
        "Dissertation": {
            "Developing e-health Platform to enhance healthcare literacy, providing rural communities with essential knowledge on prevention, treatment and wellness": {
                ...
                "link": "https://github.com/judy2002 /healthcare-literacy-platform"
            }
        }
    }
    ...
    testimonials = [
        "Masabato is a brilliant problem solver! Her final year project was truly innovative. – Mr. Clement",
        "Masabato's dedication to AI is inspiring. She never stops learning! – Lecturer. SHIMIRWA Aline Valerie",
...
# Contact section
    ...
    st.markdown("📧 Email:** judithmasabato@gmail.com")
    st.markdown("[📂 GitHub](https://github.com/judy2002 )")
...
if page == "Testimonials":
    ...
    st.write("Masabato is a brilliant problem solver! His final year project is truly innovative. – Mclement")
